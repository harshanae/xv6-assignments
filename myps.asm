...
int main(void) {
   ...
   f:	8d 5d 98             	lea    -0x68(%ebp),%ebx
int main(void) {
  12:	51                   	push   %ecx
  13:	83 ec 64             	sub    $0x64,%esp
    int return_val = mycall( NUM_STRUCTS*sizeof(struct mystruct), &struct_array);
  16:	53                   	push   %ebx
  17:	6a 50                	push   $0x50
  19:	e8 75 03 00 00       	call   393 <mycall>
  ...
  27:	90                   	nop
        printf(1,"%d  %d\n",p->value1,p->value2);
  28:	ff 73 04             	push   0x4(%ebx)
        p++;
  2b:	83 c3 08             	add    $0x8,%ebx
        printf(1,"%d  %d\n",p->value1,p->value2);
  2e:	ff 73 f8             	push   -0x8(%ebx)
  31:	68 78 07 00 00       	push   $0x778
  36:	6a 01                	push   $0x1
  38:	e8 13 04 00 00       	call   450 <printf>
    while(p != &struct_array[NUM_STRUCTS]){
  3d:	8d 45 e8             	lea    -0x18(%ebp),%eax
  40:	83 c4 10             	add    $0x10,%esp
  43:	39 c3                	cmp    %eax,%ebx
 ...
 5f1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 762:	00 00 00 
    if(p->s.size >= nunits){

...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 b2 59 10 80 	movl   $0x801059b2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103945:	68 24 79 10 80       	push   $0x80107924
...
80103c74:	75 39                	jne    80103caf <scheduler+0x7f>
      if(p->priority == 2)
80103c76:	83 7b 7c 02          	cmpl   $0x2,0x7c(%ebx)
80103c7a:	74 33                	je     80103caf <scheduler+0x7f>
      switchuvm(p);
80103c7c:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103c7f:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103c85:	53                   	push   %ebx
80103c86:	e8 b5 2e 00 00       	call   80106b40 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103c8b:	58                   	pop    %eax
80103c8c:	5a                   	pop    %edx
80103c8d:	ff 73 1c             	push   0x1c(%ebx)
80103c90:	57                   	push   %edi
      p->state = RUNNING;
80103c91:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c98:	e8 ee 0b 00 00       	call   8010488b <swtch>
      switchkvm();
80103c9d:	e8 8e 2e 00 00       	call   80106b30 <switchkvm>
      c->proc = 0;
80103ca2:	83 c4 10             	add    $0x10,%esp
80103ca5:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cac:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103caf:	83 eb 80             	sub    $0xffffff80,%ebx
80103cb2:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103cb8:	75 b6                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cba:	83 ec 0c             	sub    $0xc,%esp
80103cbd:	68 20 1d 11 80       	push   $0x80111d20
80103cc2:	e8 89 08 00 00       	call   80104550 <release>
    sti();
80103cc7:	83 c4 10             	add    $0x10,%esp
80103cca:	eb 84                	jmp    80103c50 <scheduler+0x20>
...
80103d33:	e8 53 0b 00 00       	call   8010488b <swtch>
  mycpu()->intena = intena;
...
80103dfa:	e8 b1 07 00 00       	call   801045b0 <acquire>
...
80103ec4:	53                   	push   %ebx
  pushcli();
80103ec5:	e8 96 05 00 00       	call   80104460 <pushcli>
  c = mycpu();
80103eca:	e8 21 fa ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ecf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ed5:	e8 d6 05 00 00       	call   801044b0 <popcli>
  acquire(&ptable.lock);
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 2a 05 00 00       	call   80104460 <pushcli>
  c = mycpu();
80103f36:	e8 b5 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f3b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f41:	e8 6a 05 00 00       	call   801044b0 <popcli>
  if(p == 0)
...
80103fb5:	e8 96 05 00 00       	call   80104550 <release>
        return pid;
...
80103fd3:	e8 78 05 00 00       	call   80104550 <release>
      return -1;
...
80103ffc:	e8 af 05 00 00       	call   801045b0 <acquire>
  pushcli();
80104001:	e8 5a 04 00 00       	call   80104460 <pushcli>
  c = mycpu();
80104006:	e8 e5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104011:	e8 9a 04 00 00       	call   801044b0 <popcli>
...
80104029:	e8 22 05 00 00       	call   80104550 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 0c 04 00 00       	call   80104460 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 4c 04 00 00       	call   801044b0 <popcli>
  if(p == 0)
...
80104080:	e8 2b 05 00 00       	call   801045b0 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 c3 04 00 00       	call   80104550 <release>
  p->chan = chan;
...
801040aa:	e8 a1 04 00 00       	call   80104550 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 ef 04 00 00       	jmp    801045b0 <acquire>
...
8010410f:	e8 9c 04 00 00       	call   801045b0 <acquire>
...
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 fa 03 00 00       	jmp    80104550 <release>
...
8010416f:	e8 3c 04 00 00       	call   801045b0 <acquire>
...
801041ab:	e8 a0 03 00 00       	call   80104550 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c8:	e8 83 03 00 00       	call   80104550 <release>
}
...
801041fb:	68 7b 7c 10 80       	push   $0x80107c7b
...
80104228:	8b 14 85 4c 79 10 80 	mov    -0x7fef86b4(,%eax,4),%edx
      state = "???";
...
80104265:	e8 96 01 00 00       	call   80104400 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a0:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801042a5:	c3                   	ret    
...
801042ba:	68 64 79 10 80       	push   $0x80107964
...
80104315:	e8 26 fd ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
801044f5:	68 6f 79 10 80       	push   $0x8010796f
801044fa:	e8 81 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 86 79 10 80       	push   $0x80107986
...
8010456b:	68 8d 79 10 80       	push   $0x8010798d
...
80104660:	68 95 79 10 80       	push   $0x80107995
...
80104a87:	83 fa 1d             	cmp    $0x1d,%edx
80104a8a:	77 24                	ja     80104ab0 <syscall+0x40>
80104a8c:	8b 14 85 c0 79 10 80 	mov    -0x7fef8640(,%eax,4),%edx
...
80104ab8:	68 9d 79 10 80       	push   $0x8010799d
...
80104c14:	68 58 7a 10 80       	push   $0x80107a58
...
80104c2c:	68 57 7a 10 80       	push   $0x80107a57
...
80104c41:	68 4b 7a 10 80       	push   $0x80107a4b
...
80104c5f:	68 5a 7a 10 80       	push   $0x80107a5a
80104c64:	e8 17 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 3c 7a 10 80       	push   $0x80107a3c
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 58 7a 10 80       	push   $0x80107a58
...
80105088:	68 57 7a 10 80       	push   $0x80107a57
...
801056ac:	e8 3f f3 ff ff       	call   801049f0 <argstr>

	if((ip = namei(path))==0) {
801056b1:	58                   	pop    %eax
801056b2:	ff 75 f4             	push   -0xc(%ebp)
801056b5:	e8 e6 c9 ff ff       	call   801020a0 <namei>
801056ba:	83 c4 10             	add    $0x10,%esp
801056bd:	85 c0                	test   %eax,%eax
801056bf:	74 05                	je     801056c6 <sys_getinodesize+0x26>
		return -1;
	} else {
		return (int)ip->size;
801056c1:	8b 40 58             	mov    0x58(%eax),%eax
	}
}
801056c4:	c9                   	leave  
801056c5:	c3                   	ret    
...
801057ad:	e8 7e f1 ff ff       	call   80104930 <argint>
...
801057c0:	68 80 3d 11 80       	push   $0x80113d80
801057c5:	e8 e6 ed ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057cd:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
801057e3:	68 80 3d 11 80       	push   $0x80113d80
801057e8:	68 60 3d 11 80       	push   $0x80113d60
801057ed:	e8 4e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
801057f2:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105810:	68 80 3d 11 80       	push   $0x80113d80
80105815:	e8 36 ed ff ff       	call   80104550 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105833:	68 80 3d 11 80       	push   $0x80113d80
80105838:	e8 13 ed ff ff       	call   80104550 <release>
  return 0;
...
80105854:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105857:	68 80 3d 11 80       	push   $0x80113d80
8010585c:	e8 4f ed ff ff       	call   801045b0 <acquire>
  xticks = ticks;
80105861:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105867:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
8010586e:	e8 dd ec ff ff       	call   80104550 <release>
  return xticks;
}
...
801058a0 <sys_getkernelstartaddr>:
...
801058c6:	8d 45 fc             	lea    -0x4(%ebp),%eax
801058c9:	c9                   	leave  
801058ca:	c3                   	ret    
801058cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801058cf:	90                   	nop

801058d0 <sys_getsystemcalladdr>:

int sys_getsystemcalladdr(void)
{
	return (int)sys_fork;
}
801058d0:	b8 d0 56 10 80       	mov    $0x801056d0,%eax
801058d5:	c3                   	ret    
...
801058ec:	e8 3f f0 ff ff       	call   80104930 <argint>
	myproc()->priority=x;
801058f1:	e8 7a e0 ff ff       	call   80103970 <myproc>
801058f6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058f9:	89 50 7c             	mov    %edx,0x7c(%eax)
	return myproc()->priority;
801058fc:	e8 6f e0 ff ff       	call   80103970 <myproc>
80105901:	8b 40 7c             	mov    0x7c(%eax),%eax
}
80105904:	c9                   	leave  
80105905:	c3                   	ret    
...
80105917:	e8 84 e9 ff ff       	call   801042a0 <getProcAddress>
...
80105927:	e8 04 f0 ff ff       	call   80104930 <argint>
8010592c:	83 c4 10             	add    $0x10,%esp
8010592f:	85 c0                	test   %eax,%eax
80105931:	78 5d                	js     80105990 <sys_mycall+0x80>
        return -1;
    }
...
80105939:	ff 75 f0             	push   -0x10(%ebp)
8010593c:	50                   	push   %eax
8010593d:	6a 01                	push   $0x1
8010593f:	e8 3c f0 ff ff       	call   80104980 <argptr>
80105944:	83 c4 10             	add    $0x10,%esp
80105947:	85 c0                	test   %eax,%eax
80105949:	78 45                	js     80105990 <sys_mycall+0x80>
        return -1;
    }
...
80105951:	01 c2                	add    %eax,%edx
80105953:	39 d0                	cmp    %edx,%eax
80105955:	72 20                	jb     80105977 <sys_mycall+0x67>
80105957:	eb 25                	jmp    8010597e <sys_mycall+0x6e>
...
80105960:	89 10                	mov    %edx,(%eax)
        s+=4;
        *(int *)s = p->sz;
80105962:	8b 13                	mov    (%ebx),%edx
80105964:	83 c0 08             	add    $0x8,%eax
        s+=4;
        p++;
80105967:	83 eb 80             	sub    $0xffffff80,%ebx
        *(int *)s = p->sz;
8010596a:	89 50 fc             	mov    %edx,-0x4(%eax)
    while(buf + size > s){
8010596d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105970:	03 55 f4             	add    -0xc(%ebp),%edx
80105973:	39 d0                	cmp    %edx,%eax
80105975:	73 07                	jae    8010597e <sys_mycall+0x6e>
    	if(!p->pid) {
80105977:	8b 53 10             	mov    0x10(%ebx),%edx
8010597a:	85 d2                	test   %edx,%edx
8010597c:	75 e2                	jne    80105960 <sys_mycall+0x50>
    }
...
80105a0e:	00 00 ef 
  initlock(&tickslock, "time");
80105a11:	68 9d 7a 10 80       	push   $0x80107a9d
...
80105a24:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105a2a:	e8 b1 e9 ff ff       	call   801043e0 <initlock>
}
...
80105a94:	ff 24 85 44 7b 10 80 	jmp    *-0x7fef84bc(,%eax,4)
...
80105b75:	68 00 7b 10 80       	push   $0x80107b00
...
80105bc7:	68 a8 7a 10 80       	push   $0x80107aa8
...
80105c05:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c08:	e8 63 ee ff ff       	call   80104a70 <syscall>
    if(myproc()->killed)
...
80105c85:	e8 26 e9 ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
...
80105ca4:	e8 a7 e8 ff ff       	call   80104550 <release>
...
80105ce3:	68 cc 7a 10 80       	push   $0x80107acc
80105ce8:	e8 b3 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105ced:	83 c4 14             	add    $0x14,%esp
80105cf0:	68 a2 7a 10 80       	push   $0x80107aa2
...
80105d9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d9f:	bf c4 7b 10 80       	mov    $0x80107bc4,%edi
...
80105e87:	6a 00                	push   $0x0
  jmp alltraps
80105e89:	e9 0c fb ff ff       	jmp    8010599a <alltraps>
...
80105e90:	6a 01                	push   $0x1
  jmp alltraps
80105e92:	e9 03 fb ff ff       	jmp    8010599a <alltraps>
...
80105e99:	6a 02                	push   $0x2
  jmp alltraps
80105e9b:	e9 fa fa ff ff       	jmp    8010599a <alltraps>
...
80105ea2:	6a 03                	push   $0x3
  jmp alltraps
80105ea4:	e9 f1 fa ff ff       	jmp    8010599a <alltraps>
...
80105eab:	6a 04                	push   $0x4
  jmp alltraps
80105ead:	e9 e8 fa ff ff       	jmp    8010599a <alltraps>
...
80105eb4:	6a 05                	push   $0x5
  jmp alltraps
80105eb6:	e9 df fa ff ff       	jmp    8010599a <alltraps>
...
80105ed6:	6a 09                	push   $0x9
  jmp alltraps
80105ed8:	e9 bd fa ff ff       	jmp    8010599a <alltraps>
...
80105edd:	6a 0a                	push   $0xa
  jmp alltraps
80105edf:	e9 b6 fa ff ff       	jmp    8010599a <alltraps>
...
80105ee4:	6a 0b                	push   $0xb
  jmp alltraps
80105ee6:	e9 af fa ff ff       	jmp    8010599a <alltraps>
...
80105eeb:	6a 0c                	push   $0xc
  jmp alltraps
80105eed:	e9 a8 fa ff ff       	jmp    8010599a <alltraps>
...
80105ef9:	6a 0e                	push   $0xe
  jmp alltraps
80105efb:	e9 9a fa ff ff       	jmp    8010599a <alltraps>
...
80105f12:	6a 11                	push   $0x11
  jmp alltraps
80105f14:	e9 81 fa ff ff       	jmp    8010599a <alltraps>
...
80105f1b:	6a 12                	push   $0x12
  jmp alltraps
80105f1d:	e9 78 fa ff ff       	jmp    8010599a <alltraps>
...
80105f24:	6a 13                	push   $0x13
  jmp alltraps
80105f26:	e9 6f fa ff ff       	jmp    8010599a <alltraps>
...
80105f2d:	6a 14                	push   $0x14
  jmp alltraps
80105f2f:	e9 66 fa ff ff       	jmp    8010599a <alltraps>
...
80105f36:	6a 15                	push   $0x15
  jmp alltraps
80105f38:	e9 5d fa ff ff       	jmp    8010599a <alltraps>
...
80105f3f:	6a 16                	push   $0x16
  jmp alltraps
80105f41:	e9 54 fa ff ff       	jmp    8010599a <alltraps>
...
80105f48:	6a 17                	push   $0x17
  jmp alltraps
80105f4a:	e9 4b fa ff ff       	jmp    8010599a <alltraps>
...
80105f51:	6a 18                	push   $0x18
  jmp alltraps
80105f53:	e9 42 fa ff ff       	jmp    8010599a <alltraps>
...
80105f5a:	6a 19                	push   $0x19
  jmp alltraps
80105f5c:	e9 39 fa ff ff       	jmp    8010599a <alltraps>
...
80105f63:	6a 1a                	push   $0x1a
  jmp alltraps
80105f65:	e9 30 fa ff ff       	jmp    8010599a <alltraps>
...
80105f6c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f6e:	e9 27 fa ff ff       	jmp    8010599a <alltraps>
...
80105f75:	6a 1c                	push   $0x1c
  jmp alltraps
80105f77:	e9 1e fa ff ff       	jmp    8010599a <alltraps>
...
80105f7e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f80:	e9 15 fa ff ff       	jmp    8010599a <alltraps>
...
80105f87:	6a 1e                	push   $0x1e
  jmp alltraps
80105f89:	e9 0c fa ff ff       	jmp    8010599a <alltraps>
...
80105f90:	6a 1f                	push   $0x1f
  jmp alltraps
80105f92:	e9 03 fa ff ff       	jmp    8010599a <alltraps>
...
80105f99:	6a 20                	push   $0x20
  jmp alltraps
80105f9b:	e9 fa f9 ff ff       	jmp    8010599a <alltraps>
...
801062f9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062fe:	e9 97 f6 ff ff       	jmp    8010599a <alltraps>
...
80106305:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010630a:	e9 8b f6 ff ff       	jmp    8010599a <alltraps>
...
8010631d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106322:	e9 73 f6 ff ff       	jmp    8010599a <alltraps>
...
80106329:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010632e:	e9 67 f6 ff ff       	jmp    8010599a <alltraps>
...
80106341:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106346:	e9 4f f6 ff ff       	jmp    8010599a <alltraps>
...
8010634d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106352:	e9 43 f6 ff ff       	jmp    8010599a <alltraps>
...
80106365:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010636a:	e9 2b f6 ff ff       	jmp    8010599a <alltraps>
...
80106371:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106376:	e9 1f f6 ff ff       	jmp    8010599a <alltraps>
...
80106a45:	e8 26 dc ff ff       	call   80104670 <memset>
...
80106a8d:	68 cc 7b 10 80       	push   $0x80107bcc
...
80106c7f:	e8 ec d9 ff ff       	call   80104670 <memset>
...
80106cb2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cb3:	e9 58 da ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106cb8:	83 ec 0c             	sub    $0xc,%esp
80106cbb:	68 11 7c 10 80       	push   $0x80107c11
...
80106d20:	68 2b 7c 10 80       	push   $0x80107c2b
...
80106da8:	68 cc 7c 10 80       	push   $0x80107ccc
...
80106e0b:	e8 60 d8 ff ff       	call   80104670 <memset>
...
80106e49:	68 49 7c 10 80       	push   $0x80107c49
...
80106eab:	68 61 7c 10 80       	push   $0x80107c61
...
80106f8c:	68 7d 7c 10 80       	push   $0x80107c7d
...
80106fc0:	e8 ab d6 ff ff       	call   80104670 <memset>
...
8010705c:	68 8e 7c 10 80       	push   $0x80107c8e
...
801070d2:	68 98 7c 10 80       	push   $0x80107c98
...
80107130:	e8 db d5 ff ff       	call   80104710 <memmove>
...
801071a7:	68 b2 7c 10 80       	push   $0x80107cb2
...
80107260:	e8 ab d4 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;

...
main(void)
{
  ...
  19:	e8 b5 03 00 00       	call   3d3 <open>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	0f 88 8b 00 00 00    	js     b4 <main+0xb4>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 d8 03 00 00       	call   40b <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 cc 03 00 00       	call   40b <dup>
  ...
  52:	e8 d9 04 00 00       	call   530 <printf>
    pid = fork();
  57:	e8 2f 03 00 00       	call   38b <fork>
    if(pid < 0){
  ...
  65:	74 72                	je     d9 <main+0xd9>
    ...
    int pid1 = fork();
  67:	e8 1f 03 00 00       	call   38b <fork>
    
     if(pid1 < 0){
  6c:	85 c0                	test   %eax,%eax
  6e:	0f 88 89 00 00 00    	js     fd <main+0xfd>
      printf(1, "Background service failed\n");
      exit();
    }

    if(pid1 ==0) {
  74:	0f 84 96 00 00 00    	je     110 <main+0x110>
  ...
  a1:	51                   	push   %ecx
  a2:	51                   	push   %ecx
  a3:	68 73 08 00 00       	push   $0x873
  a8:	6a 01                	push   $0x1
  aa:	e8 81 04 00 00       	call   530 <printf>
      exit();
  af:	e8 df 02 00 00       	call   393 <exit>
    mknod("console", 1, 1);
  b4:	53                   	push   %ebx
  b5:	6a 01                	push   $0x1
  b7:	6a 01                	push   $0x1
  b9:	68 58 08 00 00       	push   $0x858
  be:	e8 18 03 00 00       	call   3db <mknod>
    open("console", O_RDWR);
  c3:	58                   	pop    %eax
  c4:	5a                   	pop    %edx
  c5:	6a 02                	push   $0x2
  c7:	68 58 08 00 00       	push   $0x858
  cc:	e8 02 03 00 00       	call   3d3 <open>
  d1:	83 c4 10             	add    $0x10,%esp
  d4:	e9 50 ff ff ff       	jmp    29 <main+0x29>
      exec("sh", argv);
  d9:	50                   	push   %eax
  da:	50                   	push   %eax
  db:	68 08 0c 00 00       	push   $0xc08
  e0:	68 86 08 00 00       	push   $0x886
  e5:	e8 e1 02 00 00       	call   3cb <exec>
      printf(1, "init: exec sh failed\n");
  ea:	58                   	pop    %eax
  eb:	5a                   	pop    %edx
  ec:	68 89 08 00 00       	push   $0x889
  f1:	6a 01                	push   $0x1
  f3:	e8 38 04 00 00       	call   530 <printf>
      exit();
  f8:	e8 96 02 00 00       	call   393 <exit>
      printf(1, "Background service failed\n");
  fd:	53                   	push   %ebx
  fe:	53                   	push   %ebx
  ff:	68 9f 08 00 00       	push   $0x89f
 104:	6a 01                	push   $0x1
 106:	e8 25 04 00 00       	call   530 <printf>
      exit();
 10b:	e8 83 02 00 00       	call   393 <exit>
    	exec("myprog", argv);
 110:	50                   	push   %eax
 111:	50                   	push   %eax
 112:	68 08 0c 00 00       	push   $0xc08
 117:	68 ba 08 00 00       	push   $0x8ba
 11c:	e8 aa 02 00 00       	call   3cb <exec>
      	printf(1, "init: exec background process failed\n");
 121:	5a                   	pop    %edx
 122:	59                   	pop    %ecx
 123:	68 cc 08 00 00       	push   $0x8cc
 128:	6a 01                	push   $0x1
 12a:	e8 01 04 00 00       	call   530 <printf>
	exit();
...
00000443 <getkernelendaddr>:
SYSCALL(getkernelendaddr)
 443:	b8 19 00 00 00       	mov    $0x19,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    

0000044b <getkernelstartaddr>:
SYSCALL(getkernelstartaddr)
 44b:	b8 18 00 00 00       	mov    $0x18,%eax
 450:	cd 40                	int    $0x40
 452:	c3                   	ret    

00000453 <getkernelvariaddr>:
SYSCALL(getkernelvariaddr)
 453:	b8 1a 00 00 00       	mov    $0x1a,%eax
 458:	cd 40                	int    $0x40
 45a:	c3                   	ret    

0000045b <getsystemcalladdr>:
SYSCALL(getsystemcalladdr)
...
0000046b <getinodesize>:
SYSCALL(getinodesize)
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 54 09 00 00 	movzbl 0x954(%edx),%edx
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a9:	ff 24 85 fc 08 00 00 	jmp    *0x8fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6b7:	90                   	nop
          s = "(null)";
 6b8:	ba f2 08 00 00       	mov    $0x8f2,%edx
        while(*s != 0){

...
int main(void)
{
  ...
  23:	6a 05                	push   $0x5
  25:	e8 e9 02 00 00       	call   313 <sleep>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	eb f1                	jmp    20 <main+0x20>
  2f:	90                   	nop
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 69 07 00 00       	mov    $0x769,%edx
        while(*s != 0){
